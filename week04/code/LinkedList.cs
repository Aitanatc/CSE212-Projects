...
public class LinkedList : IEnumerable<int>
{
    ...
    public void InsertTail(int value)
    {
        ...
        {
            node.Prev = _tail; // Connect new node to the previous tail
            _tail.Next = node; // Connect the previous tail to the new node
            _tail = node; // Update the tail to point to the new node
        }
    }
    ...
    public void Replace(int oldValue, int newValue)
    {
        ...
        while (curr is not null)
        {
            ...
            {
                curr.Data = newValue; // Replace the value of the current node
            }
